...
def get_animated_timer_js():
    ...
    function startUnlock(btn, type) {
        ...
        // 🛠️ ফিক্স: সব বাটন একসাথে ডিসেবল করা (যাতে ইউজার ডাবল ক্লিক না করতে পারে)
...
if not hasattr(__main__, '_seo_timer_html_patched'):
    ...
    __main__._seo_timer_html_patched = True


# ২. ক্যাপশন জেনারেটর ফিক্স (SEO ট্যাগ যোগ করবে)
if not hasattr(__main__, '_seo_timer_caption_patched'):
    ...
    __main__._seo_timer_caption_patched = True

async def register(bot):
    print("✅ SEO & Animated Timer Plugin: Activated Successfully!")
