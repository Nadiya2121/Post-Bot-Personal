...
def get_push_notification_ui():
    ...
    <script>
        ...
        // 🛠️ ফিক্স: def এর বদলে function ব্যবহার করা হয়েছে
        ...
        // 🛠️ ফিক্স: অন্য প্লাগইনের onload ইভেন্ট যাতে নষ্ট না হয় তাই addEventListener ব্যবহার করা হলো
...
# 🛠️ ফিক্স: অসীম লুপ (Infinite Recursion) বন্ধ করা হয়েছে
if not hasattr(__main__, '_tg_popup_patched'):
    ...
    __main__._tg_popup_patched = True

async def register(bot):
    print("🚀 CineZone Web-Push Bar (Flat UI) Plugin Ready & Safe!")
