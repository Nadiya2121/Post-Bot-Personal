...
if not hasattr(__main__, "_pro_web_tools_patched"):
    ...
    def enhanced_html_code(data, links, user_ad_links_list, owner_ad_links_list, admin_share_percent=20):
        ...
        # 💡 স্মার্ট চেকার: premium_templates.py যদি আগে থেকেই স্কিমা বসিয়ে থাকে, তবে আর ডাবল বসাবে না!
        if 'type="application/ld+json"' not in html:
            seo_code = get_seo_schema(data)
        else:
            seo_code = "" # স্কিমা আগে থেকেই আছে, তাই খালি রাখা হলো
    ...
    __main__._pro_web_tools_patched = True # ফ্ল্যাগ সেট করা হলো

async def register(bot):
    # এই প্লাগইনে নতুন কোনো কমান্ডের প্রয়োজন নেই, এটি অটোমেটিক কাজ করবে
    print("💎 Pro Web Tools (Anti-AdBlock & Smart SEO): Activated Successfully!")
